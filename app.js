...
const request = {
    "add" : (data) => {
      ...
      for(var i =0; i< data.length; i+=200) {
        console.log(data.substr(i, i+200));
     }
      //console.log(store);
...
//    console.log(key);
      ...
      // If queried string has nested object within, we compare the prototype chain
        ...
        if(Array.isArray(value)){
          ...
          if(isSubObject(value, JSON.parse(line)[key]) !==true){
            matchFlag = false
            break
          }
        }
 ...
 */
 const isSubObject = (subObject, mainObject) => {
   ...
   Object.keys(subObject).forEach((key) => {
    ...
    //    console.log(subObject[key]);
    //    console.log(typeof(subObject[key]));
    //    console.log(mainObject);
    //    console.log(mainObject[key]);
